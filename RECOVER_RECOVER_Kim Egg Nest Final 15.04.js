...
lib.ssMetadata = [
		{name:"RECOVER_RECOVER_Kim Egg Nest Final 15.04_atlas_1", frames: [[1202,1410,420,578],[446,1410,754,337],[1624,1410,414,572],[1259,0,646,826],[0,663,444,580],[446,663,444,580],[892,828,444,580],[1338,828,444,580],[0,0,1257,661],[0,1245,444,580]]},
		{name:"RECOVER_RECOVER_Kim Egg Nest Final 15.04_atlas_2", frames: [[1998,50,26,2],[673,677,186,183],[1698,426,222,281],[1943,0,53,89],[1285,444,411,266],[1641,218,314,206],[1943,91,92,48],[1998,0,26,48],[0,0,412,570],[860,0,441,346],[414,0,444,472],[860,348,423,327],[1641,0,300,216],[2026,0,19,19],[1303,0,336,442],[0,572,671,143]]}
];
...
(lib.CachedBmp_25 = function() {
	this.initialize(ss["RECOVER_RECOVER_Kim Egg Nest Final 15.04_atlas_2"]);
	this.gotoAndStop(0);
...
(lib.CachedBmp_28 = function() {
	this.initialize(ss["RECOVER_RECOVER_Kim Egg Nest Final 15.04_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.Scene_1_eggs = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(576).to({_off:false},0).wait(50).to({regX:103.6,regY:142.9,rotation:7.4975,y:334.2},0).wait(4).to({regX:103.9,scaleX:0.1391,scaleY:0.1391,rotation:22.4898,x:1428.2,y:334.1},0).wait(11).to({regX:104.4,regY:143.2,rotation:37.4758,x:1427.5,y:330.8},0).wait(25).to({rotation:22.482,x:1427.45,y:330.7},0).to({_off:true},6).wait(55).to({_off:false,regX:104.9,regY:145.3,scaleX:0.1872,scaleY:0.1872,rotation:9.1821,x:1433.55,y:321.9},0).wait(5).to({regX:105,rotation:-20.8162,x:1429.15,y:322.45},0).wait(3).to({regX:100.2,regY:137.2,rotation:-20.8135,x:1429.2,y:322.5},0).wait(1).to({regX:103,regY:142.5,rotation:-5.816,x:1430.85,y:322.15},0).wait(1).to({rotation:9.1842,x:1431.65,y:321.05},0).wait(1).to({rotation:11.3271,x:1432.6,y:319.75},0).wait(1).to({rotation:13.4699,x:1433.65,y:318.5},0).wait(1).to({rotation:15.6127,x:1434.6,y:317.25},0).wait(1).to({rotation:17.7556,x:1435.6,y:316},0).wait(1).to({rotation:19.8984,x:1436.65,y:314.7},0).wait(1).to({rotation:22.0413,x:1437.65,y:313.5},0).wait(1).to({rotation:24.1841,x:1438.65,y:312.2},0).wait(1).to({rotation:26.327,x:1443.95,y:309.05},0).wait(1).to({rotation:28.4698,x:1449.3,y:305.95},0).wait(1).to({rotation:30.6126,x:1454.6,y:302.8},0).wait(1).to({rotation:32.7555,x:1459.85,y:299.75},0).wait(1).to({rotation:34.8983,x:1469.35,y:310.75},0).wait(1).to({rotation:37.0412,x:1478.85,y:321.65},0).wait(1).to({rotation:39.184,x:1488.3,y:332.7},0).wait(1).to({rotation:41.3268,x:1497.85,y:343.7},0).wait(1).to({rotation:43.4697,x:1507.25,y:354.65},0).wait(1).to({rotation:45.6125,x:1516.75,y:365.65},0).wait(1).to({rotation:47.7554,x:1526.2,y:376.6},0).wait(1).to({rotation:49.8982,x:1535.65,y:387.65},0).wait(1).to({rotation:52.0411,x:1545.15,y:398.6},0).wait(1).to({rotation:54.1839,x:1554.65,y:409.6},0).wait(1).to({x:1554.9,y:415.85},0).wait(1).to({x:1555.1,y:422.1},0).wait(1).to({x:1555.35,y:428.4},0).wait(1).to({x:1555.6,y:434.65},0).wait(1).to({x:1555.8,y:440.9},0).wait(1).to({x:1556.05,y:447.2},0).wait(1).to({x:1556.3,y:453.45},0).wait(1).to({x:1556.55,y:459.7},0).wait(1).to({x:1556.75,y:466},0).wait(1).to({x:1557,y:472.25},0).wait(1).to({x:1557.25,y:478.55},0).wait(1).to({x:1557.45,y:484.8},0).wait(1).to({x:1557.7,y:491.05},0).wait(1).to({x:1557.95,y:497.35},0).wait(1).to({x:1558.2,y:503.6},0).wait(1).to({x:1558.4,y:509.85},0).wait(1).to({x:1558.65,y:516.15},0).wait(1).to({x:1558.9,y:522.4},0).wait(1).to({x:1559.15,y:528.65},0).wait(1).to({x:1559.35,y:534.95},0).wait(1).to({x:1559.6,y:541.2},0).wait(1).to({x:1559.85,y:547.45},0).wait(1).to({x:1560.05,y:553.75},0).wait(1).to({x:1560.3,y:560},0).wait(1).to({x:1560.55,y:566.25},0).wait(1).to({x:1560.8,y:572.55},0).wait(1).to({x:1561,y:578.8},0).wait(1).to({x:1561.25,y:585.05},0).wait(1).to({x:1561.5,y:591.35},0).wait(1).to({x:1561.7,y:597.6},0).wait(1).to({x:1561.95,y:603.85},0).wait(1).to({x:1562.2,y:610.15},0).wait(1).to({x:1562.45,y:616.4},0).wait(1).to({x:1562.65,y:622.65},0).wait(1).to({x:1562.9,y:628.95},0).wait(1).to({x:1563.15,y:635.2},0).wait(1).to({x:1563.35,y:641.45},0).wait(1).to({x:1563.6,y:647.75},0).wait(1).to({x:1563.85,y:654},0).wait(1).to({x:1564.1,y:660.25},0).wait(1).to({x:1564.3,y:666.55},0).wait(1).to({x:1564.55,y:672.8},0).wait(1).to({x:1564.8,y:679.05},0).wait(1).to({x:1565.05,y:685.35},0).wait(1).to({x:1565.25,y:691.6},0).wait(1).to({x:1565.5,y:697.85},0).wait(1).to({x:1565.75,y:704.15},0).wait(1).to({x:1565.95,y:710.4},0).wait(1).to({x:1566.2,y:716.65},0).wait(1).to({x:1566.45,y:722.95},0).wait(9));
...
(lib.Scene_1_egg__up = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(1396.55,314.5,0.1533,0.1533,-14.9906,0,0,96,68.9);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(489).to({_off:false},0).wait(1).to({regX:105.8,regY:81.8,rotation:-16.6609,x:1396.7,y:314},0).wait(1).to({rotation:-18.3269,x:1394.9,y:312.05},0).wait(1).to({rotation:-19.993,x:1393.1,y:310.15},0).wait(1).to({rotation:-21.6591,x:1391.35,y:308.15},0).wait(1).to({rotation:-23.3251,x:1389.45,y:306.2},0).wait(1).to({rotation:-24.9912,x:1386.1,y:306.1},0).wait(1).to({rotation:-26.6573,x:1382.75,y:306},0).wait(1).to({rotation:-28.3233,x:1379.35,y:305.95},0).wait(1).to({rotation:-29.9894,x:1375.95,y:305.9},0).wait(1).to({rotation:-37.9797,x:1371.6,y:309.5},0).wait(1).to({rotation:-45.9701,x:1367.15,y:313.1},0).wait(1).to({rotation:-53.9604,x:1362.7,y:316.75},0).wait(1).to({rotation:-59.9616,x:1360,y:321.05},0).wait(1).to({rotation:-65.9628,x:1357.25,y:325.35},0).wait(1).to({rotation:-71.964,x:1354.55,y:329.7},0).wait(1).to({rotation:-77.9652,x:1351.75,y:334.05},0).wait(1).to({rotation:-83.9664,x:1348.9,y:338.35},0).wait(1).to({rotation:-98.9673,x:1347,y:344.2},0).wait(1).to({rotation:-113.9681,x:1344.95,y:350.05},0).wait(1).to({rotation:-128.969,x:1342.8,y:356.05},0).wait(1).to({rotation:-131.4688,x:1335.6,y:383.45},0).wait(1).to({rotation:-133.9687,x:1328.4,y:410.85},0).wait(1).to({rotation:-136.4685,x:1321.15,y:438.3},0).wait(1).to({rotation:-138.9683,x:1313.95,y:465.7},0).wait(1).to({rotation:-141.4682,x:1306.7,y:493.15},0).wait(1).to({rotation:-143.968,x:1299.5,y:520.5},0).wait(1));
...
(lib.Scene_1_egg__2_br = function(mode,startPosition,loop) {
	...
	// egg__2_br
	this.instance = new lib.appegg();
	this.instance.setTransform(1436.95,303.5,0.1664,0.1664,70.4087,0,0,122.9,107.2);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(576).to({_off:false},0).wait(1).to({regX:105.8,regY:81.8,rotation:74.4087,x:1443.35,y:304.4},0).wait(1).to({rotation:78.4086,x:1446.7,y:309.5},0).wait(1).to({rotation:82.4084,x:1450,y:314.6},0).wait(1).to({rotation:86.4083,x:1453.35,y:319.65},0).wait(1).to({rotation:90.4082,x:1456.7,y:324.8},0).wait(1).to({rotation:94.4081,x:1460,y:329.95},0).wait(1).to({rotation:98.408,x:1463.25,y:335.05},0).wait(1).to({rotation:102.4078,x:1466.45,y:340.25},0).wait(1).to({rotation:106.4077,x:1469.7,y:345.4},0).wait(1).to({rotation:110.4076,x:1472.9,y:350.6},0).wait(1).to({rotation:114.4075,x:1476,y:355.75},0).wait(1).to({rotation:118.4074,x:1479.2,y:360.95},0).wait(1).to({rotation:122.4072,x:1482.3,y:366.1},0).wait(1).to({rotation:126.4071,x:1485.4,y:371.25},0).wait(1).to({rotation:130.407,x:1488.5,y:376.5},0).wait(5));
...
// stage content:
(lib.RECOVER_RECOVER_KimEggNestFinal1504 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	this.actionFrames = [0,1,2,885,886];
	this.streamSoundSymbolsList[1] = [{id:"kimsaund",startFrame:1,endFrame:885,loop:1,offset:0}];
	...
	this.frame_1 = function() {
		var soundInstance = playSound("kimsaund",0);
	...
	this.timeline.addTween(cjs.Tween.get(this.egg__2_br).wait(1).to({regX:4.2,regY:0.9,scaleX:1.0026,scaleY:1.0026},0).wait(575).to({regX:1281.5,regY:262.7,scaleX:8.73,scaleY:8.73,x:0.45},0).wait(1).to({regX:1465.8,regY:338.5,scaleX:1,scaleY:1,x:184.4,y:75.85},0).wait(18).to({_off:true},1).wait(291));
	...
	this.timeline.addTween(cjs.Tween.get(this.egg__up).wait(1).to({regX:4.2,regY:0.9,scaleX:1.0026,scaleY:1.0026},0).wait(488).to({regX:1253.8,regY:259.6,scaleX:7.1335,scaleY:7.1335,x:0.35,y:-0.35},0).wait(1).to({regX:1348.2,regY:413.6,scaleX:1,scaleY:1,x:94.5,y:154},0).wait(25).to({_off:true},1).wait(371));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedBmp_27.png?1618820043655", id:"CachedBmp_27"},
		{src:"images/CachedBmp_30.png?1618820043655", id:"CachedBmp_30"},
		{src:"images/CachedBmp_26.png?1618820043655", id:"CachedBmp_26"},
		{src:"images/CachedBmp_5.png?1618820043655", id:"CachedBmp_5"},
		{src:"images/RECOVER_RECOVER_Kim Egg Nest Final 15.04_atlas_1.png?1618820043448", id:"RECOVER_RECOVER_Kim Egg Nest Final 15.04_atlas_1"},
		{src:"images/RECOVER_RECOVER_Kim Egg Nest Final 15.04_atlas_2.png?1618820043448", id:"RECOVER_RECOVER_Kim Egg Nest Final 15.04_atlas_2"},
		{src:"sounds/kimsaund.mp3?1618820043655", id:"kimsaund"}
	],
	preloads: []
};
